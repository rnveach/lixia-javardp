 ...
 *
 * Purpose: Panel component, handles drawing requests from server,
...
public abstract class RdesktopJPanel extends javax.swing.JPanel {
    /**
	 * 
	 */
    ...
    private InputJPanel input = null;
     ...
     */
    public RdesktopJPanel(int width, int height) {
        super();
        rop = new RasterOp();
        this.width = width;
        this.height = height;
...
//        this.bottom = height - 1; // changed
        this.right = width; // changed
        this.bottom = height; // changed
//        this.bottom = 0; // changed
    ...
    public void registerCommLayer(RdpJPanel rdp) {
        this.rdp = rdp;
        if (fbKeys != null)
            input = new Input_Localised_JPanel(this, rdp, fbKeys);
    ...
    public void registerKeyboard(KeyCode_FileBased keys) {
        ...
        if (rdp != null) {
            ...
            input = new Input_Localised_JPanel(this, rdp, keys);
        }
    }
