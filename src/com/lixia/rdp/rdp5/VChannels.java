...
public class VChannels {
    ...
    protected static Logger logger = Logger.getLogger("InputJPanel");
    ...
    public static final int CHANNEL_CHUNK_LENGTH = 1600;//the value is 1600,don't change by lijanaan 2009.12.14
